...
/// @dev This Zap Contract is for LendFlareCRV Contract, can be called by delegatecall
contract LendFlareCRVZap is IZap {
  ...
  function zap(
    ...
    if (_fromToken == THREE_CRV && _toToken == address(0)) {
      ...
      revert("LendFlareCRVZap: token pair not supported");
    }
  }
  ...
  function _swap3CRVToETH(uint256 _amountIn, uint256 _minOut) internal returns (uint256) {
    ...
    require(_ethAmount >= _minOut, "LendFlareCRVZap: insufficient output");
  ...
  function _swapETHToCRV(uint256 _amountIn, uint256 _minOut) internal returns (uint256) {
    ...
    require(_crvAmount >= _minOut, "LendFlareCRVZap: insufficient output");
  ...
  function _swapCvxCRVToCVX(uint256 _amountIn, uint256 _minOut) internal returns (uint256) {
    ...
    require(_cvxAmount >= _minOut, "LendFlareCRVZap: insufficient output");
  ...
  function _swapCRVToCvxCRV(uint256 _amountIn, uint256 _minOut) internal returns (uint256) {
    ...
    require(_amountOut >= _minOut || _amountIn >= _minOut, "LendFlareCRVZap: insufficient output");
